...
```
## Practice
How would you access the Alameda County spider data
...
#includes only customer ids that are in both table 1 and table 2
```{r}
...
`left_join`
#includes only data with customer ids from table a 
...
#includes only data with the customer ids from table b
```{r}
