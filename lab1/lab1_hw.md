...
The user interacts with RStudio that requires R, the scripting language, to run. Github is a file sharing program that is convenient for programmers to download and share files online.
